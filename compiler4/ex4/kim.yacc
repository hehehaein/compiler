...
initializer
	: constant_expression
	| LR initializer_list RR {$$=setDeclaratorInit($1,$3);}

initializer_list
    : initializer {$$=makeNode(N_INIT_LIST,$1,makeNode(N_INIT_LIST_NIL,NIL,NIL,NIL));}
...
direct_declarator
	...
	| direct_declarator LP {$$=current_id; current_level++;} parameter_type_list_opt RP {checkForwardReference(); current_id=$3; current_level--; $$=set_DeclaratorElementType($1,setTypeField(makeType(T_FUNC),$4));}
	;
...
compound_statement
    : LR {$$=current_id; current_level++;} declaration_list_opt statement_list_opt RR {checkForwardRefer    ence(); makeNode(N_STMT_COMPOUND,$3,NIL,$4); current_level--; $$=$2;}
    ;
